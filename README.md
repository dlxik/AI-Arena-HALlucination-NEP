...
Xem thêm [kế hoạch dự án](plan/README.md), [Cultural KB schema](docs/cultural-kb-schema.md), [API contract](docs/api-contract.md), [kiến trúc](docs/architecture.md) và [quy tắc đóng góp](CONTRIBUTING.md).
